...
import produits from "../mocks/productMocks";
...
const Entree = () => {
  ...
  return (
    <ProductsLayout className="enterLayout flex flex-col max-h-80">
      ...
      <Modals open={openAdd} onClose={() => setOpenAdd(false)}>
        <div className="flex flex-col gap-2 min-w-80">
          ...
          <label htmlFor="volume_entree">
            Volume entré <span className="text-red-500">*</span>
          </label>
          <input
            type="text"
            className="p-2 text-gray-900"
      ...
      >
        {selectedProduct && (
          <div className="m-8 text-center flex gap-4 flex-col capitalize">
            ...
            <p>heure_arriver:{selectedProduct.heure_arriver}</p>
            <p></p>
          </div>
        )}
      </Modals>
      ...
      <div>
        <div className="flex flex-row justify-between py-2 bg-gray-200 dark:bg-gray-700">
          ...
          <p className="w-1/4 justify-center flex">Heure Arrivée</p>
